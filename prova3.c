...
int complexMaiorQue(complex a, complex b) {
    return modulo(a) > modulo(b);
}

int complexMenorQue(complex a, complex b) {
    return modulo(a) < modulo(b);
}
...
int main() {
    ...
    printf("num1 eh maior que num2? %s\n", complexMaiorQue(num1, num2) ? "sim" : "nao");
    printf("num1 eh maior que num3? %s\n", complexMaiorQue(num1, num3) ? "sim" : "nao");
    printf("num2 eh maior que num3? %s\n", complexMaiorQue(num2, num3) ? "sim" : "nao");

    printf("num1 eh menor que num2? %s\n", complexMenorQue(num1, num2) ? "sim" : "nao");
    printf("num1 eh menor que num3? %s\n", complexMenorQue(num1, num3) ? "sim" : "nao");
    printf("num2 eh menor que num3? %s\n", complexMenorQue(num2, num3) ? "sim" : "nao");
...
modulo de num2: 2.24
modulo de num3: 2.24
num1 eh maior que num2? nao
num1 eh maior que num3? nao
num2 eh maior que num3? nao
num1 eh menor que num2? nao
num1 eh menor que num3? nao
num2 eh menor que num3? nao
*/ 
